...
import backgroundImage from "../images/mission.jpg";
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-5">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center">
        {/* Logo and Name */}
        <h1 className="text-4xl sm:text-5xl font-bold tracking-wider">MENU</h1>

        {/* Separator */}
        <div className="my-6 border-t-2 border-white w-16 mx-auto"></div>

        {/* Section Title */}
        <p className="mt-2 text-lg sm:text-xl italic">Your Taste is our Goal</p>
      ...
      {/* Navbar */}
      <div className="absolute top-0 left-0 w-full px-5 py-4 sm:px-10 sm:py-6 flex justify-between items-center">
